...
namespace Common\Util;
    ...
    class Vcode
    {
        ...
        //构造方法， 三个参数
      public  function __construct($width=100, $height=40, $num=4,$lx=1) {
            $this->width = $width;
            $this->height = $height;
            $this->num = $num;
            $this->lx = $lx;
      ...
      public  function outimg() {
        ...
        public function createcode() {
                    $lx1 = '123456789';
                    $lx2 = '123456789qwertyuiopasdfjklghzxvcbnm';
                    $lx3 = '123456780qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM';
