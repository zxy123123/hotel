	...
	*/
	class Page {
		...
		function fpage(){
			...
			$html[3] = "&nbsp;<b>{$this->page}/{$this->pageNum}</b><b>页</b>&nbsp;";
		...
		public function setLimit(){
			...
			// else
			// 	return 0;
			return $this->page.'aa'.($this->page-1)*$this->listRows.','.$this->listRows;
		}
		...
		private function goPage(){
    			if($this->pageNum > 1) {
				return '&nbsp;<input id="tiaozhuan" class="txt" style="text-align:center;border:1px solid #CCCCCC;" type="text" onkeydown="javascript:if(event.keyCode==13){var page=(this.value>'.$this->pageNum.')?'.$this->pageNum.':this.value;location=\''.$this->uri.'page=\'+page+\'\'}" value="'.$this->page.'"><input class="btt" style="line-height:34px;cursor:pointer;border:1px solid #CCCCCC;" type="button" value="GO" onclick="javascript:var page=(this.previousSibling.value>'.$this->pageNum.')?'.$this->pageNum.':this.previousSibling.value;location=\''.$this->uri.'page=\'+page+\'\'">&nbsp;';
			}
		}
