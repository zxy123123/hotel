...
<table border="1" cellpadding="1" cellspacing="1" width="100%" align="center">
		<thead>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td width="250" align="center"><?php echo ($vo["hotelname"]); ?></th>
				<td width="250" align="center"><?php echo ($vo["hotelsite"]); ?></th>
				<td width="250" align="center"><?php echo ($vo["email"]); ?></th>
				<td width="250" align="center">
				<?php if(($vo["situation"] == 1)): ?>住了吗酒店管理系统
				<?php elseif($vo["situation"] == 2): ?>其他酒店管理系统
